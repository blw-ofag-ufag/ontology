...
Laut @gruber1993translation ist "eine Ontologie eine [formale]{.underline}[^formal], [explizite]{.underline}[^explicit] Spezifikation einer [gemeinsamen]{.underline}[^shared] [Konzeptualisierung]{.underline}[^conceptualization]".
